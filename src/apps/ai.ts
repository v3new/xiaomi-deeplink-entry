...
export const ai: App[] = [
  {
    ...
    icon: 'https://play-lh.googleusercontent.com/-VnI9BrQO0PYyZG15YE6wt68KOmZ7AXGAqGti58g25ES1XdXWDBaaWUMIewHaiROwge6ibvn_b3WalmpgWGG=s64-rw',
  },
  {
    id: 'alice',
    name: 'Alice',
  ...
  },
  {
    ...
    icon: 'https://play-lh.googleusercontent.com/YeFCFSW5LkBVdsEAL_fjzxDxTbhKz31j1uZUfDbSaCeM0t4Bi3SqyHTWzWsUsZnbwjofXhYajitG_gr2_B2xil8=s64-rw',
  },
  {
    id: 'gemini',
    name: 'Gemini',
    ...
    icon: 'https://play-lh.googleusercontent.com/C64IqPWyFoCZzXVxXVl0Y6mliiNlG_sZJsqul-SBvk9ZL0wJHlU0Eho2wvsBHhho0FT5XQtH55RVGerIwXF_MA=s64-rw',
  },
  {
    id: 'qwen',
    name: 'Qwen',
    ...
    icon: 'https://play-lh.googleusercontent.com/xHa2Dp5swUn3bkD1PexbSn8pDqfLjQ_H_p4aGmh_rOaq70ZzA8HFqcRkSZFO6ZhChlus=s64-rw',
  },
  {
    id: 'deepseek',
    name: 'DeepSeek',
  ...
  },
  {
    ...
    icon: 'https://play-lh.googleusercontent.com/auZDYrlHiwgmB9VCsS9V-VeKM1-dlZmQ5K6nwLWjsBcTbGaLdxBh2TQKM0Z5k8QRrzU=s64-rw',
  },
  {
    id: 'perplexity',
    name: 'Perplexity',
